...
export const translations: Record<'ar' | 'en', Translation> = {
  ar: {
    ...
    privacyContent: [
      ...
      "لا نشارك أي بيانات مع أطراف ثالثة، لأننا ببساطة لا نجمع أي بيانات شخصية لمشاركتها.",
    ...
    homeGuidePara2: "لا يقتصر دور ليرتنا على عرض أسعار الصرف فحسب، بل نقدم لك حزمة متكاملة من الأدوات الخدمية المجانية التي صُممت لتسهيل حياتك اليومية. استخدم <a href=\"#converter\" class=\"text-emerald-600 dark:text-emerald-400 hover:underline\"><strong>محول العملات</strong></a> المتطور للتحويل الفوري والدقيق بين الليرة السورية القديمة والجديدة، وهي أداة لا غنى عنها في المعاملات اليومية. هل تحتاج لمساعد في حساب المبالغ المعقدة؟ <a href=\"#calculator\" class=\"text-emerald-600 dark:text-emerald-400 hover:underline\"><strong>حاسبة الباقي</strong></a> الذكية تساعدك في تحديد الفئات النقدية المطلوبة وتجنب الأخطاء. كما يمكنك الآن تقدير تكاليف الطاقة مع <a href=\"#electricity\" class=\"text-emerald-600 dark:text-emerald-400 hover:underline\"><strong>حاسبة فاتورة الكهرباء</strong></a> الجديدة، والتي تمنحك تفصيلاً دقيقاً لفاتورتك بناءً على استهلاكك ونوع اشتراكك وفقاً للتعرفة الرسمية. ليرتنا أكثر من مجرد أرقام، إنه رفيقك المالي اليومي.",
  ...
  en: {
    ...
    homeGuidePara2: "Liratna's role is not limited to displaying exchange rates; we offer you an integrated suite of free utility tools designed to simplify your daily life. Use our advanced <a href=\"#converter\" class=\"text-emerald-600 dark:text-emerald-400 hover:underline\"><strong>Currency Converter</strong></a> for instant and accurate conversion between the old and new Syrian Lira, an indispensable tool for daily transactions. Need help with complex calculations? Our smart <a href=\"#calculator\" class=\"text-emerald-600 dark:text-emerald-400 hover:underline\"><strong>Change Calculator</strong></a> helps you determine the required cash denominations and avoid errors. You can also now estimate your energy costs with the new <a href=\"#electricity\" class=\"text-emerald-600 dark:text-emerald-400 hover:underline\"><strong>Electricity Bill Calculator</strong></a>, which provides a detailed breakdown of your bill based on your consumption and subscription type according to official tariffs. Liratna is more than just numbers; it's your daily financial companion.",
